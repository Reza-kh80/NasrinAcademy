...
class DashboardTeacherOutlook extends Component {
    constructor(props) {
        super(props);
    ...
    getTeacherOutlook = async () => {
        await axios.get(this.state.apiEndPoint + 'TeacherOutlook/Get').then(response => {
    ...
    componentDidUpdate(prevProps, prevState) {
        if (prevState.teacherOutlookObject !== this.state.teacherOutlookObject) {
        }
    }
    handleChange = e => {
        e.persist();
        let teacherOutlookObject = { ...this.state.teacherOutlookObject };
        teacherOutlookObject[e.currentTarget.name] = e.target.value;
        this.setState({ teacherOutlookObject });
    }
    setCurrentTime = () => {
        let teacherOutlookObject = { ...this.state.teacherOutlookObject };
        teacherOutlookObject.ModificationDate = getDatetime();
        this.setState({ teacherOutlookObject });
    }
    handelSubmit = () => {
        if (this.validator.allValid()) {
            this.setCurrentTime();
            axios.post(this.state.apiEndPoint + 'TeacherOutlook/Add', this.state.teacherOutlookObject, {})
                .then(response => {
    ...
    render() {
        const {
            ...
            Modifier,
            ModificationDate,
        } = this.state.teacherOutlookObject;
        return (<div>
            <Container fluid className="table">
                <Row className="mb-2">
                    <Col xs="12" className="text-left text-dark p-0" >
                        <h3 className="text-primary"> Teacher Outlook</h3>
                    </Col>
                </Row>
                <Row className="mb-4">
                        ...
                        <div>
                            <Form onSubmit={this.handelSubmit}>
                                ...
                                <Row>
                                    <Col xs="12" md="4">
                                        <Form.Group>
                                            <Form.Label htmlFor="title"><h6 className="text-primary mb-0 ml-" >Teacher Outlook Title  (English):</h6></Form.Label>
                                        ...
                                        <Form.Group>
                                            <Form.Label htmlFor="description"><h6 className="text-primary mb-0 ml-" >Teacher Outlook Description  (English):</h6></Form.Label>
                                    ...
                                    <Col xs="12" md="4">
                                        <Form.Group>
                                            <Form.Label htmlFor="titlefr"><h6 className="text-primary mb-0 ml-" >Teacher Outlook Title  (French):</h6></Form.Label>
                                        ...
                                        <Form.Group>
                                            <Form.Label htmlFor="descriptionfr"><h6 className="text-primary mb-0 ml-" >Teacher Outlook Description  (French):</h6></Form.Label>
                                    ...
                                    <Col xs="12" md="4">
                                        <Form.Group>
                                            <Form.Label htmlFor="titlefa"><h6 className="text-primary mb-0 ml-" >Teacher Outlook Title  (Farsi):</h6></Form.Label>
                                        ...
                                        <Form.Group>
                                            <Form.Label htmlFor="descriptionfa"><h6 className="text-primary mb-0 ml-" >Teacher Outlook Description  (Farsi):</h6></Form.Label>
...
export default DashboardTeacherOutlook;
