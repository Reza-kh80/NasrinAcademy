...
class DashboardVideoOutlook extends Component {
    constructor(props) {
        super(props);
    ...
    getVideoOutlook = async () => {
        await axios.get(this.state.apiEndPoint + 'VideoOutlook/Get').then(response => {
    ...
    componentDidUpdate(prevProps, prevState) {
        if (prevState.videoOutlookObject !== this.state.videoOutlookObject) {
        }
    }
    handleChange = e => {
        e.persist();
        let videoOutlookObject = { ...this.state.videoOutlookObject };
        videoOutlookObject[e.currentTarget.name] = e.target.value;
        this.setState({ videoOutlookObject });
    }
    setCurrentTime = () => {
        let videoOutlookObject = { ...this.state.videoOutlookObject };
        videoOutlookObject.ModificationDate = getDatetime();
        this.setState({ videoOutlookObject });
    }
    handelSubmit = () => {
        if (this.validator.allValid()) {
            this.setCurrentTime();
            axios.post(this.state.apiEndPoint + 'VideoOutlook/Add', this.state.videoOutlookObject, {})
                .then(response => {
    ...
    render() {
        const {
            ...
            Modifier,
            ModificationDate,
        } = this.state.videoOutlookObject;
        return (<div>
            <Container fluid className="table">
                <Row className="mb-2">
                    <Col xs="12" className="text-left text-dark p-0" >
                        <h3 className="text-primary"> Video Outlook</h3>
                    </Col>
                </Row>
                <Row className="mb-4">
                        ...
                        <div>
                            <Form onSubmit={this.handelSubmit}>
                                ...
                                <Row>
                                    <Col xs="12" md="4">
                                        <Form.Group>
                                            <Form.Label htmlFor="title"><h6 className="text-primary mb-0 ml-" >Video Outlook Title  (English):</h6></Form.Label>
                                        ...
                                        <Form.Group>
                                            <Form.Label htmlFor="description"><h6 className="text-primary mb-0 ml-" >Video Outlook Description  (English):</h6></Form.Label>
                                    ...
                                    <Col xs="12" md="4">
                                        <Form.Group>
                                            <Form.Label htmlFor="titlefr"><h6 className="text-primary mb-0 ml-" >Video Outlook Title  (French):</h6></Form.Label>
                                        ...
                                        <Form.Group>
                                            <Form.Label htmlFor="descriptionfr"><h6 className="text-primary mb-0 ml-" >Video Outlook Description  (French):</h6></Form.Label>
                                    ...
                                    <Col xs="12" md="4">
                                        <Form.Group>
                                            <Form.Label htmlFor="titlefa"><h6 className="text-primary mb-0 ml-" >Video Outlook Title  (Farsi):</h6></Form.Label>
                                        ...
                                        <Form.Group>
                                            <Form.Label htmlFor="descriptionfa"><h6 className="text-primary mb-0 ml-" >Video Outlook Description  (Farsi):</h6></Form.Label>
...
export default DashboardVideoOutlook;
