...
class TeacherCourse extends Component {
    ...
    onEdithandler = (list) => {
        ...
        courseObject.ClassUrl = list.courseObject;
        this.setState({ courseObject });
    }
                    ...
                    <Col sm="12" md="12" >
                        <Form>
                            ...
                            <Row>
                                <Col sm="12" md="12">
                                    <Form.Group>
                                        <Form.Label htmlFor="ClassUrl"><h6 className="text-primary mb-0 ml-1" >ClassUrl :</h6></Form.Label>
                                        <Form.Control id="ClassUrl" name="ClassUrl" type="text" dir="rtl" placeholder="لینک کلاس" value={courseObject.ClassUrl} onChange={this.handleChange} />
                                        {/* {this.validator.message('ClassUrl', courseObject.ClassUrl, 'required|max:150', { className: 'alert alert-danger' })} */}
                                    </Form.Group>
                                </Col>
                            </Row>
