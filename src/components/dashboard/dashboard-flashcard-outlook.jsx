...
class DashboardFlashCardOutlook extends Component {
    constructor(props) {
        super(props);
    ...
    getFlashCardOutlook = async () => {
        await axios.get(this.state.apiEndPoint + 'FlashCardOutlook/Get').then(response => {
    ...
    componentDidUpdate(prevProps, prevState) {
        if (prevState.flashCardOutlookObject !== this.state.flashCardOutlookObject) {
        }
    }
    handleChange = e => {
        e.persist();
        let flashCardOutlookObject = { ...this.state.flashCardOutlookObject };
        flashCardOutlookObject[e.currentTarget.name] = e.target.value;
        this.setState({ flashCardOutlookObject });
    }
    setCurrentTime = () => {
        let flashCardOutlookObject = { ...this.state.flashCardOutlookObject };
        flashCardOutlookObject.ModificationDate = getDatetime();
        this.setState({ flashCardOutlookObject });
    }
    handelSubmit = () => {
        if (this.validator.allValid()) {
            this.setCurrentTime();
            axios.post(this.state.apiEndPoint + 'FlashCardOutlook/Add', this.state.flashCardOutlookObject, {})
                .then(response => {
    ...
    render() {
        const {
            ...
            Modifier,
            ModificationDate,
        } = this.state.flashCardOutlookObject;
        return (<div>
            <Container fluid className="table">
                <Row className="mb-2">
                    <Col xs="12" className="text-left text-dark p-0" >
                        <h3 className="text-primary"> FlashCard Outlook</h3>
                    </Col>
                </Row>
                <Row className="mb-4">
                        ...
                        <div>
                            <Form onSubmit={this.handelSubmit}>
                                ...
                                <Row>
                                    <Col xs="12" md="4">
                                        <Form.Group>
                                            <Form.Label htmlFor="title"><h6 className="text-primary mb-0 ml-" >FlashCard Outlook Title  (English):</h6></Form.Label>
                                        ...
                                        <Form.Group>
                                            <Form.Label htmlFor="description"><h6 className="text-primary mb-0 ml-" >FlashCard Outlook Description  (English):</h6></Form.Label>
                                    ...
                                    <Col xs="12" md="4">
                                        <Form.Group>
                                            <Form.Label htmlFor="titlefr"><h6 className="text-primary mb-0 ml-" >FlashCard Outlook Title  (French):</h6></Form.Label>
                                        ...
                                        <Form.Group>
                                            <Form.Label htmlFor="descriptionfr"><h6 className="text-primary mb-0 ml-" >FlashCard Outlook Description  (French):</h6></Form.Label>
                                    ...
                                    <Col xs="12" md="4">
                                        <Form.Group>
                                            <Form.Label htmlFor="titlefa"><h6 className="text-primary mb-0 ml-" >FlashCard Outlook Title  (Farsi):</h6></Form.Label>
                                        ...
                                        <Form.Group>
                                            <Form.Label htmlFor="descriptionfa"><h6 className="text-primary mb-0 ml-" >FlashCard Outlook Description  (Farsi):</h6></Form.Label>
...
export default DashboardFlashCardOutlook;