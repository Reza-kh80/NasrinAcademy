...
class DashboardTeacherRecritment extends Component {
    constructor(props) {
        super(props);
        this.validator = new SimpleReactValidator();
        this.state = {
            teacherRecruitmentObject: {
                TeacherRecruitmentId: "",
                Title: "",
                TitleFr: "",
                TitleFa: "",
                Description: "",
    ...
    getTeacherRecruitment = async () => {
        await axios.get(this.state.apiEndPoint + 'TeacherRecruitment/Get').then(response => {
    ...
    componentDidUpdate(prevProps, prevState) {
        if (prevState.teacherRecruitmentObject !== this.state.teacherRecruitmentObject) {
        }
    }
    handleChange = e => {
        e.persist();
        let teacherRecruitmentObject = { ...this.state.teacherRecruitmentObject };
        teacherRecruitmentObject[e.currentTarget.name] = e.target.value;
        this.setState({ teacherRecruitmentObject });
    }
    setCurrentTime = () => {
        let teacherRecruitmentObject = { ...this.state.teacherRecruitmentObject };
        teacherRecruitmentObject.ModificationDate = getDatetime();
        this.setState({ teacherRecruitmentObject });
    }
    handelSubmit = () => {
        if (this.validator.allValid()) {
            this.setCurrentTime();
            axios.post(this.state.apiEndPoint + 'TeacherRecruitment/Add', this.state.teacherRecruitmentObject, {})
                .then(response => {
    ...
    render() {
        const {
            ...
            Modifier,
            ModificationDate,
        } = this.state.teacherRecruitmentObject;
        return (<div>
            <Container fluid className="table">
                <Row className="mb-2">
                    <Col xs="12" className="text-left text-dark p-0" >
                        <h3 className="text-primary"> Teacher Recruitment</h3>
                    </Col>
                </Row>
                <Row className="mb-4">
                        ...
                        <div>
                            <Form onSubmit={this.handelSubmit}>
                                ...
                                <Row>
                                    <Col xs="12" md="4">
                                        <Form.Group>
                                            <Form.Label htmlFor="title"><h6 className="text-primary mb-0 ml-" >Teacher Recruitment Title  (English):</h6></Form.Label>
                                        ...
                                        <Form.Group>
                                            <Form.Label htmlFor="description"><h6 className="text-primary mb-0 ml-" >Teacher Recruitment Description  (English):</h6></Form.Label>
                                    ...
                                    <Col xs="12" md="4">
                                        <Form.Group>
                                            <Form.Label htmlFor="titlefr"><h6 className="text-primary mb-0 ml-" >Teacher Recruitment Title  (French):</h6></Form.Label>
                                        ...
                                        <Form.Group>
                                            <Form.Label htmlFor="descriptionfr"><h6 className="text-primary mb-0 ml-" >Teacher Recruitment Description  (French):</h6></Form.Label>
                                    ...
                                    <Col xs="12" md="4">
                                        <Form.Group>
                                            <Form.Label htmlFor="titlefa"><h6 className="text-primary mb-0 ml-" >Teacher Recruitment Title  (Farsi):</h6></Form.Label>
                                        ...
                                        <Form.Group>
                                            <Form.Label htmlFor="descriptionfa"><h6 className="text-primary mb-0 ml-" >Teacher Recruitment Description  (Farsi):</h6></Form.Label>
...
export default DashboardTeacherRecritment;