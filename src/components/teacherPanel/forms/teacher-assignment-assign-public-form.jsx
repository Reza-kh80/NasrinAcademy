...
function TeacherAssignmentAssignPublicForm(props) {
    ...
    useEffect(() => {
        ...
        if (studentId !== "" && assignmentId !== "") {
            const fetchData = async () => {
                const result = await axios.get(apiEndPoint + `TermAssignment/GetPublic?studentId=${studentId}&assignmentId=${assignmentId}`)
                if (mounted) {
    ...
    const handleSubmit = () => {
        if (simpleValidator.current.allValid()) {
            axios.post(apiEndPoint + 'TermAssignment/AddPublic', termAssignmentObject, {})
                .then(response => {
...
export default TeacherAssignmentAssignPublicForm;
