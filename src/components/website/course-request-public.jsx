...
class CourseRequestPublic extends Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            requestObject: {
                ...
                IsDeleted: false,
                PublicTermId: this.props.publicTermId,
    ...
    componentDidMount() {
        this.onNewHandeler();
        // console.log("termId from course request public= ", this.props.publicTermId)
    }
    ...
    onNewHandeler() {
        ...
        requestObject.PublicTermId = this.props.publicTermId;
    ...
    handleSubmit = () => {
        if (this.validator.allValid()) {
            this.setCurrentTime();
            axios.post(this.state.apiEndPoint + 'Student/AddPublic', this.state.requestObject, {})
                .then(response => {
                    this.props.onHide();
...
export default CourseRequestPublic;
