...
function TeacherAgreement(props) {
            ...
            <Modal
                ...
                <Modal.Header closeButton className="loginHeader p-2 align-items-center">
                    ...
                    <Modal.Title id="example-modal-sizes-title-lg" className="h4 font-weight-bold text-white pl-4">
                        <strong className="float-right"> Terms and Condition of Useing Teacher Panel</strong>
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body >
                    <Container fluid>
                            ...
                            <Col xs="12" >
                                <Tabs defaultActiveKey="1" id="uncontrolled-tab-example">
                                    <Tab eventKey="1" title="Terms and Conditions">
                                        <p className="wrap">{agrrementObject.DescriptionTeacher}</p>
                                    </Tab>
                                    <Tab eventKey="2" title="قوانین و مقررات">
                                        <p className="wrap text-right" dir="rtl" >{agrrementObject.DescriptionTeacherFa}</p>
                                    </Tab>
                                </Tabs>
                            </Col>
                        </Row>
