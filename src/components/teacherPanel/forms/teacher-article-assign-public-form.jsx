...
function TeacherArticleAssignForm(props) {
    ...
    useEffect(() => {
        ...
        if (studentId !== "" && levelId !== "") {
            const fetchData = async () => {
                const result = await axios.get(apiEndPoint + `TermArticle/GetPublic?studentId=${studentId}&levelId=${levelId}`)
                if (mounted) {
    ...
    const handleSubmit = () => {
        if (simpleValidator.current.allValid()) {
            axios.post(apiEndPoint + 'TermArticle/AddPublic', termArticleObject, {})
                .then(response => {
